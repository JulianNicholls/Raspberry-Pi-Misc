...
class ST7920:
    def __init__(self):
        ...
        # Set SPI clock to 1.2MHz, up from 125kHz, was 1.8MHz but that didn't work for me.
        # 1.25MHz seems to be OK, but 1.4MHz starts to break up so I wound it back a little.
